...
$TOKEN      = "698262436:AAELnn00eTP955q_vGxmeVx8zNkdT3QHUpM";
$usernamebot= "@SpkdBot"; // sesuaikan besar kecilnya, bermanfaat nanti jika bot dimasukkan grup.
   ...
   // identifikasi perintah (yakni kata pertama, atau array pertamanya)
    switch ($command[0]) {
        ...
        case '/time'.$usernamebot :
            ...
            break;
        case '/about':
        case '/about'.$usernamebot :
            $hasil  = "Ini adalah Bot assistance dari Sopokondo";
            break;
